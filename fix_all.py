...
// Order requested:
// 1. Fleet Owners & Transport Partners
// 2. 3PL & Cross-Border Partners
// 3. Riders & Couriers
const carriers = [
    {
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col items-center">
                ...
                <div className="relative max-w-5xl w-full mx-auto flex flex-col items-center">
                    ...
                    <div className="space-y-32 flex flex-col relative w-full">
                        ...
                        <div className="hidden lg:block absolute left-1/2 top-0 w-1 h-32 bg-gradient-to-b from-transparent via-cyan-400 to-transparent -translate-x-1/2 blur-[2px]" style={{ animation: 'moveDown 4s linear infinite' }} />
