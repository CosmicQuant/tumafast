...
const ChatAssistant: React.FC = () => {
  ...
  return (
    <div className={`fixed ${isOpen ? 'inset-0 h-[100dvh]' : 'bottom-20 right-4'} z-[9999] flex flex-col items-end pb-[env(safe-area-inset-bottom,0px)]`}>
      {isOpen && (
        <div className="bg-white shadow-2xl border border-gray-100 w-full h-full sm:w-96 sm:h-[500px] sm:rounded-2xl mb-0 sm:mb-4 flex flex-col overflow-hidden transition-all duration-300 animate-in slide-in-from-bottom-10 fade-in pb-[env(safe-area-inset-bottom,20px)]">
          {/* Header */}
